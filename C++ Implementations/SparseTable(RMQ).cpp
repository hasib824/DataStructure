/*
Sparse Table RMQ (range minimum/maximum query)

using Sparse Table  use kore Range minimum/maximum query er jonno
O(nlogn) a pre calculation kore .

Every query te O(1) complexity te result deya jay .
